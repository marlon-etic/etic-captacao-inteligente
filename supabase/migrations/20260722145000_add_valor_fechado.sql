-- Migration: Add valor_fechado column to negotiation_records
ALTER TABLE public.negotiation_records ADD COLUMN IF NOT EXISTS valor_fechado numeric DEFAULT 0;

-- Ensure auth seed for marlon@eticimoveis.com.br (idempotent)
DO $$
DECLARE
  new_user_id uuid;
BEGIN
