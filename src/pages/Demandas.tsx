  ...
  return (
    <div className="space-y-[16px] md:space-y-[24px]">
      <div className="animate-fade-in-up">
        <h1 className="text-[28px] md:text-[32px] font-black tracking-tight text-[#1A3A52]">
          Demandas e Captações
        </h1>
        <p className="text-[#999999] text-sm font-medium mt-1">
          Acompanhe todas as demandas abertas e gerencie os imóveis captados.
        </p>
      </div>
