    ...
    <div className="px-[16px] pb-[72px] pt-[24px] max-w-7xl mx-auto flex flex-col w-full">
      <Tabs defaultValue="demandas" className="w-full flex flex-col gap-[16px]">
        ...
        <TabsContent value="meus-clientes" className="m-0">
          <MyClientsCapturedView filterType="Aluguel" />
        </TabsContent>
        <TabsContent value="disponiveis" className="m-0">
          <LoosePropertiesView filterType="Aluguel" />
        </TabsContent>
        <TabsContent value="captados" className="m-0">
          <CapturedPropertiesView
            filterType="Aluguel"
            emptyStateText="Nenhum imóvel de aluguel captado no momento"
          />
        </TabsContent>
