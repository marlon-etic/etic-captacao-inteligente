...
//   CREATE OR REPLACE FUNCTION public.append_captador_busca(p_demanda_id uuid, p_tipo_demanda text, p_captador_id uuid, p_nome text, p_regiao text)
//    RETURNS void
//    LANGUAGE plpgsql
//    SECURITY DEFINER
//   AS $function$
...
//   trg_notify_busca_iniciada_locacao: CREATE TRIGGER trg_notify_busca_iniciada_locacao AFTER UPDATE OF captadores_busca ON public.demandas_locacao FOR EACH ROW EXECUTE FUNCTION trg_notify_busca_iniciada_multipla()
